...
need to [restart your spork server]() whenever certain Rails environment files
...
(If you're using Guard instead, check out [guard-spork](https://github.com/guard/guard-spork)
